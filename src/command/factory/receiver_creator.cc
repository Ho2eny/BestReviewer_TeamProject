...
UserReceiverCreator::UserReceiverCreator(Cache &cache) : ReceiverCreator(cache) {}
std::unique_ptr<Receiver> UserReceiverCreator::CreateAReceiver(const CommandType &type) const
{
...
RoomReceiverCreator::RoomReceiverCreator(Cache &cache) : ReceiverCreator(cache) {}
std::unique_ptr<Receiver> RoomReceiverCreator::CreateAReceiver(const CommandType &type) const
{
...
ChatReceiverCreator::ChatReceiverCreator(Cache &cache) : ReceiverCreator(cache) {}
std::unique_ptr<Receiver> ChatReceiverCreator::CreateAReceiver(const CommandType &type) const
{
